...
compileExprAt baseIndex expr =
  case expr of
    ...
    BinaryExpr {binaryExprOp = AndOperator, binaryExprLeft = left, binaryExprRight = right} -> compileLogicalExpr compileExprAt AndOperator baseIndex left right
    BinaryExpr {binaryExprOp = OrOperator, binaryExprLeft = left, binaryExprRight = right} -> compileLogicalExpr compileExprAt OrOperator baseIndex left right
