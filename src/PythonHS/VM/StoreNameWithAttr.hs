...
storeNameWithAttr scopeCtx name value globalsNow localsNow =
  let isTopLevelNow = vmScopeContextIsTopLevel scopeCtx
      globalDeclsNow = vmScopeContextGlobalDecls scopeCtx
